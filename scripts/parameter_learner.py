#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Bayesian optimization of beam-search parameters.

Starts SC2 once and updates trial parameters through the HTTP API.

Usage: python scripts/parameter_learner.py --config configs/learner_config.yaml
"""
...
class ParameterLearner:
    ...
    def _execute_trial(self, trial: optuna.Trial, params: dict) -> float:
        ...
        send_params["pause_when_target_reached"] = True
