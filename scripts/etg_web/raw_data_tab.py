...
import numpy as np
from etg_web.constants import NPY_DIR
from etg_web.loaders import (
    load_episode_data,
    load_distance_matrix_np,
    load_state_hp_data,
)
from etg_web.raw_data_utils import compute_mds, _build_hp_diff_array, plot_mds_terrain
...
@st.fragment
def _run_mds_terrain(map_id, data_id, n_states_etg):
